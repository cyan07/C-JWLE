%clear all;
function save_dir = get_bird_dataset(Nsub, k, perc, cl, k_N, k_NS)
...
%addpath( genpath( 'new' ));
vl_setup;
rootdir = '/home/haichao/experiment/bird';
...
load('/home/haichao/experiment/bird/birdset.mat')
%load('/home/haichao/experiment/bird/image_class_label.mat');%the label for 95041
load('/home/haichao/experiment/bird/bird_fea.mat','feature');%the visual feature of aug_set,15w*4096    
load('/home/haichao/experiment/bird/index_2w_2_7k.mat','index_2w_2_7k');%the id of aug_set in original set(95041)
% load('/home/haichao/experiment/bird/image_click_bird_0_img_Fea_Clickcount.mat','img_Fea_ClickCount');%9.5w*48w
% click_fea = img_Fea_ClickCount;
load('/home/haichao/experiment/bird/click_A_huanyuan.mat')

% %compare
% str = ['rand_idx_' num2str(min(NsubIndex)) '-' num2str(max(NsubIndex))];
% train_= randperm(size(birdset,1),size(sub_train,1));
% sub_train = birdset(train_,:);
% sub_test = birdset;
% sub_test(train_,:)=[];
% save(fullfile( rootdir,['compare_' num2str(Nsub) '_' num2str(cl) '_' str '.mat']), 'train_','sub_train', 'sub_test', '-v7.3');

try
load( fullfile( rootdir, ['alter/train_test_datafea_' num2str(Nsub) '_' num2str(cl) '_'  str '.mat']));%,'sub_train','sub_test','sub_test_id','sub_train_id','aug_train_id','train_click_col','test_click_col','-v7.3');
load(fullfile( rootdir,['alter/train_test_feature_' num2str(Nsub) '_' num2str(cl) '_'  str '.mat']));%,'aug_train_feature','train_click_fea', 'tr_click_fea','test_click_fea','t_click_fea','sub_train_clickfea','-v7.3');
...
load( fullfile(  rootdir, 'alter', ['train_feature_' num2str(Nsub) '_' num2str(cl) '_'  str '.mat']));%, 'train_feature','-v7.3');
load( fullfile(  rootdir, 'alter', ['test_feature_' num2str(Nsub) '_' num2str(cl) '_'  str '.mat']));%, 'test_feature', '-v7.3');
catch
...
[~,sub_train_id] = ismember(sub_train(:,2),index_2w_2_7k);
[~,train_i] = ismember(index_2w_2_7k,sub_train(:,2));
train_id = find(train_i);
[~,sub_test_id] = ismember(sub_test(:,2),index_2w_2_7k);
aug_train_id = sub_train(train_i(train_id),1);
aug_id = index_2w_2_7k(train_id);
...
t_click_fea = click_fea(sub_test(:,1),:);
...
save( fullfile( rootdir, ['alter/train_test_datafea_' num2str(Nsub) '_' num2str(cl) '_'  str '.mat']),'train_id','aug_id','sub_test_id','sub_train_id','aug_train_id','train_click_col','test_click_col','-v7.3');
save(fullfile( rootdir,['alter/train_test_feature_' num2str(Nsub) '_' num2str(cl) '_'  str '.mat']),'sub_train_feature','sub_test_feature','aug_train_feature','train_click_fea', 'tr_click_fea','test_click_fea','t_click_fea','sub_train_clickfea','-v7.3');
...
train_feature = get_fea(NsubIndex,sub_train(:,[2,3]),aug_id,aug_train_feature);
save( fullfile(  rootdir, 'alter', ['train_feature_' num2str(Nsub) '_' num2str(cl) '_'  str '.mat']), 'train_feature','-v7.3');
test_feature = get_fea(NsubIndex,sub_test(:,[2,3]),sub_test(:,2),sub_test_feature);
save( fullfile(  rootdir, 'alter', ['test_feature_' num2str(Nsub) '_' num2str(cl) '_'  str '.mat']), 'test_feature', '-v7.3');
end
...
% for i = 1 : length(km)
%     NSClass = km(i);
    load('/home/haichao/experiment/bird/bird_new_snumtrain.mat');
    
%     load('/home/haichao/experiment/bird/bird_snumtrain.mat');
%     new_snumtrain = snumtrain;
%     
...
%test_feature_set = get_featureset(test_feature,NSClass);
    ...
    [train_sim, train_subsim, train_rsort, map_train, aug_train, sort_map_org] = get_parama_for_bird(train_feature_set, NSClass, index_2w_2_7k); 
...
% save(fullfile( rootdir, 'subLabel_kmeans/alter/acc', ['acc_top1_NTt_Na_' num2str(Nsub) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'acc');
% %M1 method: augmentation
% acc = get_NTt_acc(click_fea,train_click_col,test_click_col,aug_train_id,sub_test_id,Q_dNUM,train_label,test_true_label)
% save(fullfile( rootdir, 'subLabel_kmeans/alter/acc', ['acc_top1_NTt_M1_' num2str(Nsub) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'acc');
% %M2 method: augmentation and propagate
% acc = get_NTt_pro_acc(data_fea,click_fea,train_click_col,test_click_col,aug_train_id,sub_test,NsubIndex,Q_dNUM,train_label,test_true_label,perc,t)
...
% % end
% acc = get_NTt_struc_acc(aug_train_feature,data_fea,click_fea,train_click_col,test_click_col,aug_train_id,sub_test,NsubIndex,Q_dNUM,train_label,test_true_label,NSClass,perc,k_N,k_NS)
% save(fullfile( rootdir, 'subLabel_kmeans/alter/acc', ['acc_top1_NTt_M3_' num2str(Nsub) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'acc');
...
%save(fullfile(rootdir,'subLabel_kmeans/alter/IDX',['IDX_Fea_kmeans_Na_',num2str(Nsub),'-',num2str(cl),'-',num2str(NSClass),'-',num2str(perc),'-',num2str(1),'-', str,'.mat']),'IDX_s','Fea_s','-v7.3');
IDX = [IDX_s;train_click_col];
ID =  IDX';
ID = sortrows(ID,2);
%save(fullfile( rootdir, 'subLabel_kmeans/alter/IDX', ['query_IDX_Na_' num2str(Nsub) '_' num2str(cl) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'IDX','ID', '-v7.3');

%Na map:
load(fullfile(rootdir,'alter/map',['test_map_train_Na_' num2str(Nsub) '_' num2str(cl) '_' str '.mat']))
acc = get_top_n_acc(test_true_label,sub_train(:,3),ID,query_id,i_t,i_tr,sub_train_clickfea,test_click_fea,1)
%save(fullfile( rootdir, 'subLabel_kmeans/alter/acc', ['acc_top1_Na-Na_' num2str(Nsub) '_' num2str(cl) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'acc');
F_ACC = [F_ACC,acc];
end
% %M1 map
% load(fullfile(rootdir,'alter/map',['test_map_train_M1_' num2str(Nsub) '_' num2str(cl) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']))
% acc = get_top_n_acc(test_true_label,sub_train(:,2),ID,query_id,i_t,i_tr,sub_train_clickfea,test_click_fea,1)
% save(fullfile( rootdir, 'subLabel_kmeans/alter/acc', ['acc_top1_M1-Na_' num2str(Nsub) '_' num2str(cl) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'acc');
% %M2 map
...
% acc = get_top_n_acc(test_true_label,sub_train(:,2),ID,query_id,i_t,i_tr,sub_train_clickfea,test_click_fea,1)
% save(fullfile( rootdir, 'subLabel_kmeans/alter/acc', ['acc_top1_M2-Na_' num2str(Nsub) '_' num2str(cl) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'acc');
...
[Fea_mul IDX_mul ] = vl_kmeans(full(y_fea), Q_NUM);
%save(fullfile(rootdir,'subLabel_kmeans/alter/IDX',['IDX_Fea_kmeans_M1_',num2str(Nsub),'-',num2str(cl),'-',num2str(NSClass),'-',num2str(perc),'-',num2str(1),'-', str,'.mat']),'IDX_mul','Fea_mul','-v7.3');
IDX = [IDX_mul;train_click_col];
ID =  IDX';
ID = sortrows(ID,2);
%[IDX ID] = cat_idx(IDX_sig, IDX_mul,train_map_label,train_click_col);
%save(fullfile( rootdir, 'subLabel_kmeans/alter/IDX', ['query_IDX_M1_' num2str(Nsub) '_' num2str(cl) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'IDX','ID', '-v7.3');
...
%save(fullfile( rootdir, 'subLabel_kmeans/alter/acc', ['acc_top1_Na-M1_' num2str(Nsub) '_' num2str(cl) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'acc');
F_ACC = [F_ACC,acc];
end
% %M1 map -M1
% load(fullfile(rootdir,'subLabel_kmeans/alter/map',['test_map_train_M1_' num2str(Nsub) '_' num2str(cl) '_' str '.mat']))%num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']))
% acc = get_top_n_acc(test_true_label,train_label,ID,query_id,i_t,i_tr,train_click_fea,test_click_fea,1)
% save(fullfile( rootdir, 'subLabel_kmeans/alter/acc', ['acc_top1_M1-M1_' num2str(Nsub) '_' num2str(cl) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'acc');
% %M2 map -M1
% load(fullfile(rootdir,'subLabel_kmeans/alter/map',['test_map_train_M2_' num2str(Nsub) '_' num2str(cl) '_' str '.mat']))%'_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']))
% acc = get_top_n_acc(test_true_label,train_label,ID,query_id,i_t,i_tr,train_click_fea,test_click_fea,1)
% save(fullfile( rootdir, 'subLabel_kmeans/alter/acc', ['acc_top1_M2-M1_' num2str(Nsub) '_' num2str(cl) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'acc');
% %M3 map -M1
%%%
...
%save(fullfile(rootdir,'subLabel_kmeans/alter/IDX',['IDX_Fea_kmeans_M2_',num2str(Nsub),'-',num2str(NSClass),'-',num2str(perc),'-',num2str(1),'-', str,'.mat']),'IDX_p','Fea_p','-v7.3');
IDX = [IDX_p;train_click_col];
ID =  IDX';
ID = sortrows(ID,2);
%save(fullfile( rootdir, 'subLabel_kmeans/alter/IDX', ['query_IDX_M2_' num2str(Nsub) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'IDX','ID', '-v7.3');
...
% save(fullfile( rootdir, 'subLabel_kmeans/alter/acc', ['acc_top1_Na-M2_' num2str(Nsub) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'acc');
% %M1 map -M2
% load(fullfile(rootdir,'subLabel_kmeans/alter/map',['test_map_train_M1_' num2str(Nsub) '_' str '.mat']))%'_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']))
% acc = get_top_n_acc(test_true_label,train_label,ID,query_id,i_t,i_tr,train_click_fea,test_click_fea,1)
% save(fullfile( rootdir, 'subLabel_kmeans/alter/acc', ['acc_top1_M1-M2_' num2str(Nsub) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'acc');
% %M2 map -M2
% load(fullfile(rootdir,'subLabel_kmeans/alter/map',['test_map_train_M2_' num2str(Nsub) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']))
% acc = get_top_n_acc(test_true_label,train_label,ID,query_id,i_t,i_tr,train_click_fea,test_click_fea,1)
% save(fullfile( rootdir, 'subLabel_kmeans/alter/acc', ['acc_top1_M2-M2_' num2str(Nsub) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'acc');
% %M3 map -M2
% %%
...
%      k_NS = k_S(5);
%      perc =a_rate(5);
%      load(fullfile( rootdir, 'alter/kmeans/perc', ['train_profea_' num2str(Nsub) '_' num2str(cl) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']),'train_data');
      F_ACC = [];
 for i = 1 : 5
data = train_data;
    [m,n,l,o] = size(data);
...
% data = reshape(data, [m*n, o]);
% %Q_dNUM = length(train_map_label{1,2}) + Q_NUM;
% [Fea_md IDX_md ] = vl_kmeans(data, Q_dNUM);
...
acc = get_top_n_acc(test_true_label,train_label,ID,query_id,i_t,i_tr,train_click_fea,test_click_fea,1)
%m_acc = get_top_n_acc(test_true_label,train_label,m_ID,query_id,i_t,i_tr,train_click_fea,test_click_fea,1)
...
F_ACC = [F_ACC,acc];
 ...
 %end
% %M1 map -M3
% load(fullfile(rootdir,'subLabel_kmeans/alter/map',['test_map_train_M1_' num2str(Nsub) '_' num2str(cl) '_' str '.mat']))
% acc = get_top_n_acc(test_true_label,train_label,ID,query_id,i_t,i_tr,train_click_fea,test_click_fea,1)
% m_acc = get_top_n_acc(test_true_label,train_label,m_ID,query_id,i_t,i_tr,train_click_fea,test_click_fea,1)
% save(fullfile( rootdir, 'subLabel_kmeans/alter/acc', ['acc_top1_M1-M3_' num2str(Nsub) '_' num2str(cl) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'acc','m_acc');
% %M2 map -M3
% load(fullfile(rootdir,'subLabel_kmeans/alter/map',['test_map_train_M2_' num2str(Nsub) '_' num2str(cl) '_' str '.mat']))%'_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']))
% acc = get_top_n_acc(test_true_label,train_label,ID,query_id,i_t,i_tr,train_click_fea,test_click_fea,1)
% m_acc = get_top_n_acc(test_true_label,train_label,m_ID,query_id,i_t,i_tr,train_click_fea,test_click_fea,1)
% save(fullfile( rootdir, 'subLabel_kmeans/alter/acc', ['acc_top1_M2-M3_' num2str(Nsub) '_' num2str(cl) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'acc','m_acc');
% %M3 map -M3
...
% m_ID =  m_IDX';
% m_ID = sortrows(m_ID,2);
%save(fullfile( rootdir, 'torch/IDX', ['query_IDX_M4_33_' num2str(256) '_0.8_20_0.9_0.01_' num2str(cl) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'IDX','ID');%,'m_IDX','m_ID', '-v7.3');
%Na map -M4
load(fullfile(rootdir,'alter/map',['test_map_train_Na_' num2str(Nsub) '_' num2str(cl) '_' str '.mat']))
acc = get_top_n_acc(test_true_label,train_label,ID,query_id,i_t,i_tr,train_click_fea,test_click_fea,1)
%m_acc = get_top_n_acc(test_true_label,train_label,m_ID,query_id,i_t,i_tr,train_click_fea,test_click_fea,1)
save(fullfile( rootdir, 'torch/acc', ['acc_top1_Na-M4_33_' num2str(256) '_0.8_20_0.9_0.01_' num2str(cl) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'acc');%,'m_acc');

% %M1 map -M4
% load(fullfile(rootdir,'subLabel_kmeans/alter/map',['test_map_train_M1_' num2str(Nsub) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']))
% acc = get_top_n_acc(test_true_label,train_label,ID,query_id,i_t,i_tr,train_click_fea,test_click_fea,1)
% m_acc = get_top_n_acc(test_true_label,train_label,m_ID,query_id,i_t,i_tr,train_click_fea,test_click_fea,1)
% save(fullfile( rootdir, 'subLabel_kmeans/alter/acc', ['acc_top1_M1-M4_33_' num2str(Nsub) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'acc');%,'m_acc');
% %M2 map -M4
% load(fullfile(rootdir,'subLabel_kmeans/alter/map',['test_map_train_M2_' num2str(Nsub) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']))
% acc = get_top_n_acc(test_true_label,train_label,ID,query_id,i_t,i_tr,train_click_fea,test_click_fea,1)
% m_acc = get_top_n_acc(test_true_label,train_label,m_ID,query_id,i_t,i_tr,train_click_fea,test_click_fea,1)
% save(fullfile( rootdir, 'subLabel_kmeans/alter/acc', ['acc_top1_M2-M4_33_' num2str(Nsub) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'acc');%,'m_acc');
% %M3 map -M4
...
save(fullfile( rootdir, 'torch/acc', ['acc_top1_Na-M5_33_' num2str(0.0001) '_' num2str(cl) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'acc');%,'m_acc');

% %M1 map -M3
% load(fullfile(rootdir,'subLabel_kmeans/alter/map',['test_map_train_M1_' num2str(Nsub) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']))
% acc = get_top_n_acc(test_true_label,train_label,ID,query_id,i_t,i_tr,train_click_fea,test_click_fea,1)
% m_acc = get_top_n_acc(test_true_label,train_label,m_ID,query_id,i_t,i_tr,train_click_fea,test_click_fea,1)
% save(fullfile( rootdir, 'subLabel_kmeans/alter/acc', ['acc_top1_M1-M5_4' num2str(Nsub) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'acc');%,'m_acc');
% %M2 map -M3
% load(fullfile(rootdir,'subLabel_kmeans/alter/map',['test_map_train_M2_' num2str(Nsub) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']))
% acc = get_top_n_acc(test_true_label,train_label,ID,query_id,i_t,i_tr,train_click_fea,test_click_fea,1)
% m_acc = get_top_n_acc(test_true_label,train_label,m_ID,query_id,i_t,i_tr,train_click_fea,test_click_fea,1)
% save(fullfile( rootdir, 'subLabel_kmeans/alter/acc', ['acc_top1_M2-M5_4' num2str(Nsub) '_' num2str(NSClass) '_' num2str(perc) '_' num2str(k_N) '_' num2str(k_NS) '_' str '.mat']), 'acc');%,'m_acc');
% %M3 map -M3
