% function [sim, subsim, rsort, sort_map_org] = get_param(feature_set, NSClass) 
function [sim, subsim, rsort, aug_data_idx, sort_map_org] = get_parama(feature_set, NSClass, index_21w_2_9w)
%%computer similarity
...
%%get_map_idx1
[map_org_idx aug_data_idx] = map_idx(feature_set, rsort, index_21w_2_9w, NSClass);
